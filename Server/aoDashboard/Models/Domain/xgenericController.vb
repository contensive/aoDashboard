...
'            Return GetDodad(cp, nodeConfig.addonGUID, nodeConfig.contentGUID, nodeConfig.contentName, nodeConfig.title, nodeConfig.x, nodeConfig.y, nodeConfig.state, nodeConfig.sizex, nodeConfig.sizey, AddonOptions, nodeConfig.wrapperId, nodeConfig.key, nodeConfig.z)
'        End Function
'        ''' <summary>
